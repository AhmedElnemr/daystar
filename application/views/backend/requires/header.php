...
<head>
    <meta charset="utf-8"/>
    <title><?= (isset($title)) ? $title : lang('home') ?></title>
    ...
    <!--end::Web font -->
    <?php if ($this->AdminLang == "ar"): ?>
        <!--RTL version:-->
        <link href="<?= base_url() . ADMINASSETS ?>vendors/base/vendors.bundle.rtl.css?v=<?=VER?>" rel="stylesheet"
              type="text/css"/>
        <link href="<?= base_url() . ADMINASSETS ?>demo/default/base/style.bundle.rtl.css?v=<?=VER?>" rel="stylesheet"
              type="text/css"/>
    <?php else: ?>
        <link href="<?= base_url() . ADMINASSETS ?>vendors/base/vendors.bundle.css?v=<?=VER?>" rel="stylesheet" type="text/css"/>
        <link href="<?= base_url() . ADMINASSETS ?>demo/default/base/style.bundle.css?v=<?=VER?>" rel="stylesheet"
              type="text/css"/>
    <?php endif ?>
	<link href="<?= base_url() . ADMINASSETS ?>demo/default/base/style.css?v=<?=time()?>" rel="stylesheet"
		  type="text/css"/>
            ...
            <div class="m-stack m-stack--ver m-stack--desktop">
                    ...
                    <div class="m-stack m-stack--ver m-stack--general">
                        <div class="m-stack__item m-stack__item--middle m-brand__logo">
                            <a href="<?= base_url() ?>" class="m-brand__logo-wrapper">
                                <!--<img alt=""
                                     src="<?/*= base_url() . ADMINASSETS */?>demo/default/media/img/logo/logo_default_dark.png"/>-->
                                    لوحة التحكم
                            </a>
                        </div>
                ...
                <div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
                   <div class="admin-logo">
                     <!-- <img src="<?/*= base_url().FAVICONPATH .'daystar.png'*/?>" />-->
                   </div>
                   <div class="clock">
                            ...
                            <ul class="m-topbar__nav m-nav m-nav--inline">
                                    ...
                                    <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url(<?/*= base_url() . ADMINASSETS */?>app/media/img/misc/notification_bg.jpg); background-size: cover;">
                                ...
                                <li class="m-nav__item m-topbar__quick-actions m-topbar__quick-actions--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push m-dropdown--mobile-full-width m-dropdown--skin-light"
                                    ...
                                    <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url(<?/*= base_url() . ADMINASSETS */?>app/media/img/misc/quick_actions_bg.jpg); background-size: cover;">
												...
												<span class="m-nav__link-text">
                                                    ...
                                                    */?>
													<img class="m-topbar__language-selected-img"
                                                         src="<?/*= base_url() . ADMINASSETS */?>app/media/img/flags/<?/*=$flag*/?>">
												</span>
                                    </a>
                                    <div class="m-dropdown__wrapper">
                                        <span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url(<?/*= base_url() . ADMINASSETS */?>app/media/img/misc/quick_actions_bg.jpg); background-size: cover;">
                                                <span class="m-dropdown__header-subtitle"><?/*=lang('Select_your_language')*/?></span>
                                            </div>
                                            <div class="m-dropdown__body">
                                                <div class="m-dropdown__content">
                                                    <?php
/*                                                    $get   = $this->input->get();
                                                    $searchKey = $this->AdminLang."/";
                                                    $path  = str_replace($searchKey, "", uri_string());
                                                    $path  = str_replace($searchKey, "",$path);
                                                    $path .= (isset($get) && !empty($get))? creatGetUrl($get):"" ;
                                                    */?>
                                                    <ul class="m-nav m-nav--skin-light">
                                                        <li class="m-nav__item m-nav__item--active">
                                                            <a href="<?/*=base_url()."en/".$path*/?>" class="m-nav__link">
                                                                <span class="m-nav__link-icon">
                                                                    <img class="m-topbar__language-img"
                                                                         src="<?/*= base_url() . ADMINASSETS */?>app/media/img/flags/020-flag.svg"></span>
                                                                <span class="m-nav__link-title m-topbar__language-text m-nav__link-text"><?/*=lang('english')*/?></span>
                                                            </a>
                                                        </li>
                                                        <li class="m-nav__item">
                                                            <a href="<?/*=base_url()."ar/".$path*/?>" class="m-nav__link">
                                                                <span class="m-nav__link-icon"><img
                                                                            class="m-topbar__language-img"
                                                                            src="<?/*= base_url() . ADMINASSETS */?>app/media/img/flags/008-saudi-arabia.svg"></span>
                                                                <span class="m-nav__link-title m-topbar__language-text m-nav__link-text"><?/*=lang('arabic')*/?></span>
                                                            </a>
                                                        </li>
                                ...
                                <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                    ...
                                    <a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
                                                     <?php if (!empty($_SESSION['image']) && is_file("uploads/images/" . $_SESSION['image'])) { ?>
                                                         <img src="<?php echo base_url() .IMAGEPATH . $_SESSION['image'] ?>"
                                                              alt="user" class="m--img-rounded m--marginless"/>
                                                     <?php } else { ?>
                                                         <img src="<?php echo base_url().FAVICONPATH ?>DE.png"
                                                              alt="user" class="m--img-rounded m--marginless"/>
                                                     <?php } ?>
												</span>
                                    ...
                                    <div class="m-dropdown__wrapper">
                                        ...
                                        <div class="m-dropdown__inner">
                                            <div class="m-dropdown__header m--align-center"
                                                 style="background: url(<?= base_url() . ADMINASSETS ?>app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
                                                <div class="m-card-user m-card-user--skin-dark">
                                                    <div class="m-card-user__pic">
                                                        ...
                                                        <!--
                                                            ...
                                                            <span class="m--font-light">S<span>
                                                            <span>
					                                 	-->
                                                    </div>
                                                    <div class="m-card-user__details">
                                                        <span class="m-card-user__name m--font-weight-500"><?=(isset($_SESSION["name"]))? $_SESSION["name"]:lang('user')?></span>
                                                    ...
                                                    <ul class="m-nav m-nav--skin-light">
                                                            ...
                                                            <a href="#" class="m-nav__link">
                                                                ...
                                                                <span class="m-nav__link-title">
																			<span class="m-nav__link-wrap">
																				<span class="m-nav__link-text"><?=lang('my_profile')?></span>
																			</span>
																		</span>
                                                            </a>
                                                        </li>
                                                        <li class="m-nav__item">
                                                            <a href="#" class="m-nav__link">
                                                                ...
                                                                <span class="m-nav__link-text"><?=lang('Inbox')?></span>
                                                            </a>
                                                        </li>
                                                                ...
                                                                <span class="m-nav__link-text">
                                                                  ...
                                                                  :
                                                                    <?php if(!empty($_SESSION['last_login'])){
                                                                        echo  date("d-m-Y",$_SESSION['last_login']) ;
                                                                    }
                                                                    else {
